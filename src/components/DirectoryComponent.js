...
class Directory extends Component {
    constructor(props) { //whenever you create a class component in react that has a costructor method, "props" (short for properties) is required followed by super(props);
        super(props);
        this.state = {
            campsites: [
                {
